<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddDichVu.aspx.cs" Inherits="SpaWeb.Admin.AddDichVu" EnableEventValidation = "false" validateRequest="false" %>
    ...
    <div class="row" style="padding:50px">
            ...
            <div class="row" style="width: 100%">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txt_tenDV" runat="server" CssClass="form-control"></asp:TextBox>                  
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txt_gia" runat="server" CssClass="form-control"></asp:TextBox>                  
                </div>
                 <div class="form-group">
                    <asp:Label ID="Label4" runat="server" Text="Số Lượng dùng ban đầu" CssClass="control-label" for="txt_tenSP"></asp:Label>
                    
                    <asp:TextBox ID="txt_soluong" runat="server" CssClass="form-control"></asp:TextBox>                  
                </div>
                <div class="form-group">
                ...
                <div class="form-group has-success has-feedback" style="width:100%">
                    ...
                    <asp:TextBox ID="txt_ChiTiet" TextMode="multiline" Rows="5" runat="server" CssClass="form-control" Height="150px"></asp:TextBox>
                    <script>CKEDITOR.replace('ContentPlaceHolder1_txt_ChiTiet');</script>
