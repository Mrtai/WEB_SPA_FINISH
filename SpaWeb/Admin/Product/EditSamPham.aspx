<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSamPham.aspx.cs" Inherits="SpaWeb.Admin.Product.EditSamPham"  validateRequest="false"%>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="h1 text-uppercase text-center text-primary">Cập Nhật Sản Phẩm</div>
            <asp:Label runat="server" Text="" ID="lb_messenger"
                Visible="false"
                CssClass="h3 text-danger"></asp:Label>
